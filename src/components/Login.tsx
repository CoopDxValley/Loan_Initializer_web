...
const Login = ({ setSignup, setLogin }: any) => {
  ...
  return (
    <div className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-[#fff] z-10 flex flex-col items-center min-w-fit sm:w-[400px] border-[1px] border-[#6D7E8C] m-5 p-5 px-[40px]">
      <div
      ...
      <form
        ...
        className="grid gap-5 gap-x-8 w-full self-center"
      >
        ...
        <button
          ...
          type="submit"
          className="flex justify-center border-[1px] border-[#6D7E8C] bg-[#1C5BC2] p-2 rounded-[5px] mt-4"
        >
          {formSubmitted && (
            <svg
              className="
          ...
          <span className="text-[#fff]">
            {!formSubmitted ? "Login" : "Please Wait"}
          </span>
        </button>
      </form>
